...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_FIXED_WORKERS, "평민 인구의 38%를 작업 가능 인구로 고정"},
    ...
    {TR_CONFIG_WINE_COUNTS_IF_OPEN_TRADE_ROUTE, "개통된 무역로의 포도주는 서로 다른 포도주로 간주"},
    ...
    {TR_BUILDING_ROADBLOCK_DESC, "도로 블록이 배회하는 시민들을 가로막습니다."},
    {TR_BUILDING_ARCHITECT_GUILD, "건축가 길드" },
    {TR_BUILDING_ARCHITECT_GUILD_DESC, "이곳의 건축가가들은 로마의 영광을 위한 기념물을 세우기 위해 부지런히 일합니다."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_BONUS_DESC, "우물 및 분수의 효과 범위가 +1, 저수조의 범위가 +2 증가합니다. 물공급에 필요한 노동력이 50% 감소합니다. 무역선이 25% 빠르게 이동합니다."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_MARS_MODULE_1_DESC, "마르스 신전들이 해당 신전 성직자들의 서비스를 받는 도시 인에 비례한 만큼의 식량을 자체 생산하여 보급창으로 배달합니다."},
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "비너스 대성전이 비너스 신전의 서비스를 받는 도시 인구에 비례한 만큼의 포도주를 생산합니다. 각 비너스 신전들은 이것을 모아 각 집과 선술집으로 분배합니다."},
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_2_DESC, "성직자들이 스스 오락을 제공하고 주택의 미관을 개선하여 추가적인 장식물 없이도 도시를 매력적으로 만듭니다."},
    {TR_BUILDING_PANTHEON_MODULE_1_DESC, "모든 도시의 신전들이 각자 성직자를 판테온으로 보내서 서로의 신앙과 축복을 퍼뜨립니다." },
    {TR_BUILDING_PANTHEON_MODULE_2_DESC, "판테온에 접근할 수 있는 집들은 추가로 한 단계 더 진화할 수 있습니다."},
